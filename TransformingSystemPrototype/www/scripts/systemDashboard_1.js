function dashboard(myId) {
    ...
    function calculateWidth() {
        ...
        var _width = (window.devicePixelRatio * $(window).width()) * 0.90;
        //var _width = $("#pdHolder").width();
    ...
    function drawInnerArcsWithText() {
        ...
        if (ie == 8) {
            //simple new line center aligns the text
            svg.append("g")
    ...
    function drawOuterArcsWithText() {
        ...
        if (ie != 8) {
            ...
            var outerArc1 = d3.svg.arc()
                .outerRadius(radius_outer - outer_text_spacing - (radius_outer_thickness * .7));
            var outerArc2 = d3.svg.arc()
                .outerRadius(radius_outer - outer_text_spacing - (radius_outer_thickness * .3));
            ...
            g_outerArcsTextPath
                ...
                .attr("class", function (d) {
                    return "outerArcsTextPath";
                })
                .attr("d", function (d) {
                    var _centerAngle = d.startAngle + (d.endAngle - d.startAngle) / 2;
            ...
            d3.select("g.outerArcsTextPath")
                ...
                .attr("text-anchor", "middle")
                .style("font-size", fontSizeOuter + "px")
                .style("font-weight", fontWeightOuter)
                ...
                .attr("fill", function (d) {
                    return d.data.colorFg;
                })
                .text(function (d) {
                    return d.data.title.toUpperCase();
                });
